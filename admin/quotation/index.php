...
if(isset($_GET['type']) && $_GET['type']=="delete"){
    $id = $_GET['id'];
    $q = "delete from quotation where id = '$id'"; 
   mysqli_query($conn,$q);
...
$q = "select * from quotation order by id desc";
...
<div class="container-fluid my-3">
    ...
    <a href="<?php echo $base_url ?>/admin/quotation/index.php" class="list-group-item list-group-item-action active">Quotations</a>
    ...
    <a href="<?php echo $base_url ?>/admin/teams/index.php" class="list-group-item list-group-item-action">Teams</a>
        ...
        <div class="col-md-10">
            <h5 class="bg-primary text-center text-light p-2">Quotation Queries</h5>
