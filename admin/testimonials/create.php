...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $q = "insert into testimonials(name,pic,profile,message) values('$name','$pic','$profile','$message')";
...
<div class="container-fluid my-3">
    <div class="row">
        ...
        <div class="col-md-10">
            <h5 class="bg-primary text-center text-light p-2">Create Testimonials </h5>
